...
for(var i = 0; i < professors.length; i++) {
	...
	name.className = "name-professor";
	name.innerText = professors[i].name;
	...
	info_div.className = "info-professor";
		...
		if(professors[i].instagram != "") {
			...
			instagram_div.innerHTML = `<span class="material-icons"> person </span> <a href="{professors[i].instagram}"> instagram</a>`
	...
	var cards_div = document.getElementsByClassName("cards_professor")[0];
